...
printf "\n"
printf "\e[1;104m     trknbash v1.0, Coded by: brig1d3sint3rn1ti0n1ll3s/trhacknon (IG/Github)     \e[0m\n"
printf "\n"
...
printf "\e[1;92mUse ./trknbash.sh --resume\n"
else
exit 1
fi
